...
/* changes by Friedrich Weber: Use the garbage collector */
#ifndef bstr__alloc
#define bstr__alloc(x) sk_malloc (x)
#endif

#ifndef bstr__free
#define bstr__free(p) sk_free (p)
#endif

#ifndef bstr__realloc
#define bstr__realloc(p,x) sk_realloc ((p), (x))
#endif
